...
function ENT:Use(activator, caller)
    ...
    local activatorm = activator:GetNWInt("playerMoney")
    local printerGivemoney = self.StoredMoney

    tonumber(activator:SetNWInt("playerMoney", activatorm + ent.StoredMoney))
    ent.StoredMoney = 0
end

function Produce(ent)
    ent.StoredMoney = ent.StoredMoney + ent.Give
end
